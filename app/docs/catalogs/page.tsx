...
export const metadata: Metadata = {
  title: 'Каталоги и брошюры | ENT Engineering',
  description: 'Каталоги и брошюры ENT Engineering.',
}
...
export default function CatalogsPage() {
  const sections = [
    {
      id: 1,
      title: 'Каталоги преобразователей частоты',
      items: [
        { id: 1, name: 'Каталог Модели 1/000', file: '/docs/catalogs/ent100.pdf' },
        { id: 2, name: 'Каталог Модели 2/001', file: '/docs/catalogs/ent100.pdf' },
      ],
    },
    {
      id: 2,
      title: 'Каталоги электродвигателей',
      items: [
        { id: 1, name: 'Каталог Модели 1/010', file: '/docs/catalogs/ent100.pdf' },
        { id: 2, name: 'Каталог Модели 2/011', file: '/docs/catalogs/ent100.pdf' },
      ],
    },
    {
      id: 3,
      title: 'Каталоги устройств плавного пуска',
      items: [
        { id: 1, name: 'Каталог Модели 1/020', file: '/docs/catalogs/ent100.pdf' },
        { id: 2, name: 'Каталог Модели 2/021', file: '/docs/catalogs/ent100.pdf' },
      ],
    },
  ]
      ...
      <section className="py-10 sm:py-14 lg:py-16">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-white/70 mb-6">
            ...
            <span className="text-[#FE924A]">Каталоги и брошюры</span>
          </nav>
