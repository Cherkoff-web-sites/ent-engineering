...
export const metadata: Metadata = {
  title: 'Опросные листы | ENT Engineering',
  description: 'Опросные листы ENT Engineering.',
}
...
export default function QuestionnairesPage() {
  const sections = [
    {
      id: 1,
      title: 'Опросные листы по преобразователям частоты',
      items: [
        { id: 1, name: 'Опросный лист Модели 1/000', file: '/docs/questionnaires/ent100.pdf' },
        { id: 2, name: 'Опросный лист Модели 2/001', file: '/docs/questionnaires/ent100.pdf' },
      ],
    },
    {
      id: 2,
      title: 'Опросные листы по электродвигателям',
      items: [
        { id: 1, name: 'Опросный лист Модели 1/010', file: '/docs/questionnaires/ent100.pdf' },
        { id: 2, name: 'Опросный лист Модели 2/011', file: '/docs/questionnaires/ent100.pdf' },
      ],
    },
    {
      id: 3,
      title: 'Опросные листы по устройствам плавного пуска',
      items: [
        { id: 1, name: 'Опросный лист Модели 1/020', file: '/docs/questionnaires/ent100.pdf' },
        { id: 2, name: 'Опросный лист Модели 2/021', file: '/docs/questionnaires/ent100.pdf' },
      ],
    },
  ]
      ...
      <section className="py-10 sm:py-14 lg:py-16">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-white/70 mb-6">
            ...
            <span className="text-[#FE924A]">Опросные листы</span>
          </nav>
