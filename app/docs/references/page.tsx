...
export const metadata: Metadata = {
  title: 'Референции | ENT Engineering',
  description: 'Референции ENT Engineering.',
}
...
export default function ReferencesPage() {
  const sections = [
    {
      id: 1,
      title: 'Референции по преобразователям частоты',
      items: [
        { id: 1, name: 'Референции Модели 1/000', file: '/docs/references/ent100.pdf' },
        { id: 2, name: 'Референции Модели 2/001', file: '/docs/references/ent100.pdf' },
        { id: 3, name: 'Референции Модели 3/002', file: '/docs/references/ent100.pdf' },
        { id: 4, name: 'Референции Модели 4/003', file: '/docs/references/ent100.pdf' },
        { id: 5, name: 'Референции Модели 5/004', file: '/docs/references/ent100.pdf' },
      ],
    },
    {
      id: 2,
      title: 'Референции по электродвигателям',
      items: [
        { id: 1, name: 'Референции Модели 1/010', file: '/docs/references/ent100.pdf' },
        { id: 2, name: 'Референции Модели 2/011', file: '/docs/references/ent100.pdf' },
        { id: 3, name: 'Референции Модели 3/012', file: '/docs/references/ent100.pdf' },
      ],
    },
    {
      id: 3,
      title: 'Референции по устройствам плавного пуска',
      items: [
        { id: 1, name: 'Референции Модели 1/020', file: '/docs/references/ent100.pdf' },
        { id: 2, name: 'Референции Модели 2/021', file: '/docs/references/ent100.pdf' },
      ],
    },
  ]
      ...
      <section className="py-10 sm:py-14 lg:py-16">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-white/70 mb-6">
            ...
            <span className="text-[#FE924A]">Референции</span>
          </nav>
