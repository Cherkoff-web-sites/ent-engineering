...
export const metadata: Metadata = {
  title: 'Сертификаты | ENT Engineering',
  description: 'Сертификаты ENT Engineering.',
}
...
export default function CertificatesPage() {
  const sections = [
    {
      id: 1,
      title: 'Сертификаты преобразователей частоты',
      items: [
        { id: 1, name: 'Сертификат Модели 1/000', file: '/docs/certificates/ent100.pdf' },
        { id: 2, name: 'Сертификат Модели 2/001', file: '/docs/certificates/ent100.pdf' },
      ],
    },
    {
      id: 2,
      title: 'Сертификаты электродвигателей',
      items: [
        { id: 1, name: 'Сертификат Модели 1/010', file: '/docs/certificates/ent100.pdf' },
        { id: 2, name: 'Сертификат Модели 2/011', file: '/docs/certificates/ent100.pdf' },
      ],
    },
    {
      id: 3,
      title: 'Сертификаты устройств плавного пуска',
      items: [
        { id: 1, name: 'Сертификат Модели 1/020', file: '/docs/certificates/ent100.pdf' },
        { id: 2, name: 'Сертификат Модели 2/021', file: '/docs/certificates/ent100.pdf' },
      ],
    },
  ]
      ...
      <section className="py-10 sm:py-14 lg:py-16">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-white/70 mb-6">
            ...
            <span className="text-[#FE924A]">Сертификаты</span>
          </nav>
