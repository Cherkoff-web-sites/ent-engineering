...
export default function SoftwarePage() {
  const sections = [
    {
      id: 1,
      title: 'Программное обеспечение для преобразователей частоты',
      items: [
        { id: 1, name: 'ПО Модели 1/000', file: '/docs/software/ent100.pdf' },
        { id: 2, name: 'ПО Модели 2/001', file: '/docs/software/ent100.pdf' },
        { id: 3, name: 'ПО Модели 3/002', file: '/docs/software/ent100.pdf' },
      ],
    },
    {
      id: 2,
      title: 'Программное обеспечение для электродвигателей',
      items: [
        { id: 1, name: 'ПО Модели 1/010', file: '/docs/software/ent100.pdf' },
        { id: 2, name: 'ПО Модели 2/011', file: '/docs/software/ent100.pdf' },
      ],
    },
    {
      id: 3,
      title: 'Программное обеспечение для устройств плавного пуска',
      items: [
        { id: 1, name: 'ПО Модели 1/020', file: '/docs/software/ent100.pdf' },
        { id: 2, name: 'ПО Модели 2/021', file: '/docs/software/ent100.pdf' },
      ],
    },
  ]
      ...
      <section className="py-10 sm:py-14 lg:py-16">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-white/70 mb-6">
            ...
            <span className="text-[#FE924A]">Программное обеспечение</span>
          </nav>
